...
forms! {
    ...
    DiscordWasCommand => "discord_was_command",
    DiscordWasButton => "discord_was_button",
    DiscordWasReaction => "discord_was_reaction",
    DiscordJoined => "discord_joined",
    DiscordLeft => "discord_left",
    DiscordId => "discord_id",
    DiscordPeopleHere => "discord_people_here",
    DiscordChannelsHere => "discord_channels_here",
    DiscordTheirRoles => "discord_their_roles",
    DiscordOfferCommand => "discord_offer_command",
    DiscordOfferCommandTaking => "discord_offer_command_taking",
    DiscordCommandUsed => "discord_command_used",
    DiscordCommandGave => "discord_command_gave",
    DiscordReplyQuietly => "discord_reply_quietly",
    DiscordAnnounce => "discord_announce",
    DiscordCorrect => "discord_correct",
    DiscordDelete => "discord_delete",
    DiscordReact => "discord_react",
    DiscordTyping => "discord_typing",
    DiscordCard => "discord_card",
    DiscordCardFull => "discord_card_full",
    DiscordButtons => "discord_buttons",
    DiscordButtonPressed => "discord_button_pressed",
    DiscordEmojiUsed => "discord_emoji_used",
    DiscordGiveRole => "discord_give_role",
    DiscordTakeRole => "discord_take_role",
    DiscordHasRole => "discord_has_role",
    DiscordKick => "discord_kick",
    DiscordBan => "discord_ban",
    DiscordQuieten => "discord_quieten",
    DiscordNickname => "discord_nickname",
